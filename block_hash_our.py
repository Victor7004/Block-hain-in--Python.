#Создание нашей блокчейн системы на основе полученных знаний
#Тут нам нужно просто взять всё, что мы написали в прошлых уроках и сделать какой-нибудь простенький интерфейс для пользователя (в консоли), поскольку глобально новых функций не будет. Дополнительные комментарии к коду не требуются.
...
while run:  # Основной цикл программы
    ...
    print('Это может занаять несколько минут')
    t1 = time()
